...
<main class="auth-page">
    <div class="auth-box">
        <h2>Verify Code</h2>
        <p style="color: #888; text-align: center; margin-bottom: 25px;">
            We've sent a 6-digit code to <strong><?php echo htmlspecialchars($email); ?></strong>.<br>
            <small style="display: block; margin-top: 10px;">If you don't see it, please check your <strong>spam folder</strong>.</small>
        </p>
