    ...
    <header class="main-header" id="mainHeader">
        <div class="container navbar">
            ...
            <div class="nav-right">
                ...
                <?php if(is_logged_in()): ?>
                    <div class="user-menu" onclick="document.querySelector('.dropdown').classList.toggle('show')">
                        <?php 
                        ...
                        try {
                            ...
                            // Column missing or other DB error
                        }
                        ?>
                        <div class="user-avatar" style="<?php echo !empty($profile_pic) ? "background-image: url('$profile_pic'); background-size: cover; background-position: center; border: 2px solid var(--primary);" : ""; ?>">
                            <?php if(empty($profile_pic)) echo strtoupper(substr($_SESSION['username'], 0, 1)); ?>
                        </div>
                        <span style="font-size:14px; font-weight: 600;"><?php echo $_SESSION['username']; ?></span>
                        <div class="dropdown">
                            <?php if(is_admin()): ?>
